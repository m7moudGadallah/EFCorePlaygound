...
namespace CFDataAnnotations.Migrations
{
    ...
    [Migration("20250219184751_CreateStudentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CFDataAnnotations.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CFDataAnnotations.Models.Track", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CFDataAnnotations.Models.Student", b =>
                {
                    b.HasOne("CFDataAnnotations.Models.Track", "Track")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("CourseTrack", b =>
                {
                    b.HasOne("CFDataAnnotations.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CFDataAnnotations.Models.Track", null)
                        .WithMany()
